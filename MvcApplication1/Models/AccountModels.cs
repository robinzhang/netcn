...
{ 
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        static string conn_str = System.Configuration.ConfigurationManager.ConnectionStrings["netcn"].ConnectionString;
        ...
        { 
            ...
            SqlCommand cmd = new SqlCommand("select count(1) from  Users where (UserName=@UserName and Pwd=@Pwd)",conn);
        ...
        public MembershipCreateStatus CreateUser(string userName, string password)
        {
            ...
            try
            {
                ...
                conn.Close();
                cmd = new SqlCommand("insert into Users (UserName,Pwd,Role,CreateTime) values (@UserName,@Pwd,0,getdate())", conn);
                cmd.Parameters.Add(new SqlParameter("@UserName", userName));
                cmd.Parameters.Add(new SqlParameter("@Pwd", password));
                try
                {
